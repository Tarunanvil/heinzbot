...
/////////////////
const BotName = 'HEINZ BOT'; 
const instagram = 'https://instagram.com/tarunaryw'; 
const telegram = 'https://t.me/petrusnotfound'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/tarunahistory';
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@tarunaryw`)
})
